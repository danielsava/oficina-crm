    ...
    <div class="space-y-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <p-button 
                ...
                icon="pi pi-plus" 
                styleClass="bg-[#2453d7] hover:bg-[#1d40b0] text-white px-5 py-2.5 rounded-[12px] text-[15px] font-medium shadow-[0_4px_14px_0_rgba(36,83,215,0.3)] transition-all flex items-center justify-center gap-2 border-none">
            </p-button>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Resumo Diário -->
            <p-card styleClass="lg:col-span-2 bg-white rounded-[20px] shadow-[0_2px_10px_0_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col min-h-[160px] h-full [&>.p-card-body]:p-6 [&>.p-card-body]:h-full [&>.p-card-content]:h-full [&>.p-card-content]:flex [&>.p-card-content]:flex-col [&>.p-card-content]:p-0">
                <ng-template pTemplate="content">
                    <h2 class="text-[17px] font-semibold text-slate-800 mb-6 m-0">Resumo Diário</h2>
            ...
            <!-- Faturamento Mensal -->
            <p-card styleClass="bg-white rounded-[20px] shadow-[0_2px_10px_0_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col relative overflow-hidden min-h-[160px] [&>.p-card-body]:p-6 [&>.p-card-body]:h-full [&>.p-card-content]:h-full [&>.p-card-content]:flex [&>.p-card-content]:flex-col [&>.p-card-content]:p-0">
                <ng-template pTemplate="content">
                    <div class="flex justify-end mb-2">
                        <p-button 
                            ...
                            iconPos="right"
                            [text]="true"
                            styleClass="p-0 text-[13px] text-slate-500 font-medium hover:text-slate-800 transition-colors bg-transparent [&>.p-button-icon]:text-[10px]">
                        </p-button>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            <p-card styleClass="lg:col-span-2 bg-white rounded-[24px] shadow-[0_4px_24px_0_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col [&>.p-card-body]:p-6 [&>.p-card-content]:p-0">
                <ng-template pTemplate="content">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-[19px] font-semibold text-slate-800 m-0">Próximos Agendamentos</h2>
                            ...
                            @for (item of [1,2,3]; track item) {
                                <div class="grid grid-cols-12 gap-4 items-center bg-white shadow-[4px_10px_24px_0_rgba(0,0,0,0.06)] hover:shadow-[6px_14px_32px_0_rgba(0,0,0,0.1)] hover:-translate-y-0.5 transition-all duration-300 rounded-[20px] p-4 border border-slate-50/50 cursor-pointer">
                                    <div class="col-span-4 flex items-center gap-3">
                                        <div class="w-9 h-9 flex items-center justify-center text-slate-600 bg-slate-50 rounded-full">
            ...
            <!-- Serviços do Dia -->
            <p-card styleClass="bg-white rounded-[24px] shadow-[0_4px_24px_0_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col [&>.p-card-body]:p-6 [&>.p-card-content]:p-0">
                <ng-template pTemplate="content">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-[19px] font-semibold text-slate-800 m-0">Serviços do Dia</h2>
                        <a href="javascript:void(0)" class="text-[14px] text-[#2453d7] font-medium flex items-center gap-1 hover:text-[#1d40b0] transition-colors">
                            Ver mais <i class="pi pi-arrow-right text-[11px] font-bold"></i>
                        </a>
                    </div>
