...
@Component({
    ...
    template: `<div id="video" style="max-width: 1200px" class="flex gap-6 mt-12 py-12 flex-col items-center w-full">
        ...
        <div class="mt-4 relative">
            ...
            <div class="absolute z-0" style="top: -50px; left: -50px"><img [attr.draggable]="false" class="opacity-40" src="/demo/images/landing/landing-ellipse.png" alt="" /></div>
            <div class="absolute z-0" style="bottom: -50px; right: -50px; filter: blur(4px)"><img [attr.draggable]="false" class="opacity-40" src="/demo/images/landing/landing-ellipse2.png" alt="" /></div>
            <div class="absolute z-0" style="bottom: -50px; right: 10px; filter: blur(4px)"><img [attr.draggable]="false" class="opacity-40" src="/demo/images/landing/landing-ellipse2.png" alt="" /></div>
        </div>
    </div>`
})
