...
import { Topbar } from '@/app/pages/landing/components/topbar';
import { HeroWidget } from '@/app/pages/landing/components/herowidget';
import { WhoUsesWidget } from '@/app/pages/landing/components/whouses';
import { CollaborationWidget } from '@/app/pages/landing/components/collaborationwidget';
import { EasyFollowWidget } from '@/app/pages/landing/components/easyfollowwidget';
import { ShowReelsWidget } from '@/app/pages/landing/components/showreelswidget';
import { NewsletterWidget } from '@/app/pages/landing/components/newsletterwidget';
